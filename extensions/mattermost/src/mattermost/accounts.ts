...
export function listMattermostAccountIds(cfg: SimpleClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SimpleClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SimpleClawConfig): ResolvedMattermostAccount[] {
