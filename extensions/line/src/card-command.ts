import type { LineChannelData, SimpleClawPluginApi, ReplyPayload } from "simpleclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: SimpleClawPluginApi): void {
  api.registerCommand({
    name: "card",
