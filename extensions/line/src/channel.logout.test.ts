import type { SimpleClawConfig, PluginRuntime, ResolvedLineAccount } from "simpleclaw/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: SimpleClawConfig; accountId: string }): Promise<{
