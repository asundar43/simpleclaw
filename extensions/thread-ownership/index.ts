import type { SimpleClawConfig, SimpleClawPluginApi } from "simpleclaw/plugin-sdk";
...
function resolveOwnershipAgent(config: SimpleClawConfig): { id: string; name: string } {
