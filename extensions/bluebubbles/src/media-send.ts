...
import { resolveChannelMediaMaxBytes, type SimpleClawConfig } from "simpleclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: SimpleClawConfig; accountId?: string }): string[] {
