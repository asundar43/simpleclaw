...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "simpleclaw/plugin-sdk";
...
import { resolvePreferredSimpleClawTmpDir } from "../../../src/infra/tmp-simpleclaw-dir.js";
import {
  type MSTeamsAdapter,
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(
        path.join(resolvePreferredSimpleClawTmpDir(), "msteams-mention-"),
      );
