...
import type { ReplyPayload, SimpleClawConfig } from "simpleclaw/plugin-sdk";
import { createReplyPrefixOptions } from "simpleclaw/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // SimpleClawConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SimpleClawConfig;
