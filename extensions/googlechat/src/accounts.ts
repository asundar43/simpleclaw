...
export function listGoogleChatAccountIds(cfg: SimpleClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SimpleClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SimpleClawConfig): ResolvedGoogleChatAccount[] {
