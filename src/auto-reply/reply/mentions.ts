...
function resolveMentionPatterns(cfg: SimpleClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SimpleClawConfig | undefined, agentId?: string): RegExp[] {
