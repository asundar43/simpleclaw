...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("simpleclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "simpleclaw");
