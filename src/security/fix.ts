...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SimpleClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SimpleClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SimpleClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
