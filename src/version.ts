...
declare const __SIMPLECLAW_VERSION__: string | undefined;
declare const __OPENCLAW_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "simpleclaw";
...
export function resolveRuntimeServiceVersion(
  ...
  return (
    firstNonEmpty(
      env["SIMPLECLAW_VERSION"],
      env["SIMPLECLAW_SERVICE_VERSION"],
...
// Single source of truth for the current SimpleClaw version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION =
  (typeof __SIMPLECLAW_VERSION__ === "string" && __SIMPLECLAW_VERSION__) ||
  (typeof __OPENCLAW_VERSION__ === "string" && __OPENCLAW_VERSION__) ||
  process.env.SIMPLECLAW_BUNDLED_VERSION ||
