...
export function listWhatsAppAuthDirs(cfg: SimpleClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SimpleClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SimpleClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SimpleClawConfig): ResolvedWhatsAppAccount[] {
