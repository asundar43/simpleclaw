...
export function listBindings(cfg: SimpleClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: SimpleClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SimpleClawConfig) {
