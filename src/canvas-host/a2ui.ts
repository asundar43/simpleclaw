...
export const A2UI_PATH = "/__simpleclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__simpleclaw__/canvas";

export const CANVAS_WS_PATH = "/__simpleclaw__/ws";
...
(() => {
  ...
  const handlerNames = ["simpleClawCanvasA2UIAction"];
  ...
  globalThis.SimpleClaw = globalThis.SimpleClaw ?? {};
  globalThis.SimpleClaw.postMessage = postToNode;
  globalThis.SimpleClaw.sendUserAction = sendUserAction;
  globalThis.simpleClawPostMessage = postToNode;
