...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.simpleclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", SIMPLECLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.simpleclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.simpleclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when SIMPLECLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.simpleclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when SIMPLECLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", SIMPLECLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.simpleclaw.jbphoenix.plist",
    },
    {
      name: "prefers SIMPLECLAW_LAUNCHD_LABEL over SIMPLECLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        SIMPLECLAW_PROFILE: "jbphoenix",
        SIMPLECLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from SIMPLECLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        SIMPLECLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty SIMPLECLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        SIMPLECLAW_PROFILE: "myprofile",
        SIMPLECLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.simpleclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
