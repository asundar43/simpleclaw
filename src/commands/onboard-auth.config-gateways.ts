...
export function applyVercelAiGatewayProviderConfig(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: SimpleClawConfig): SimpleClawConfig {
