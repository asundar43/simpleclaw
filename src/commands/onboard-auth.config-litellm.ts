...
export function applyLitellmProviderConfig(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyLitellmConfig(cfg: SimpleClawConfig): SimpleClawConfig {
