...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.simpleclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("simpleclaw hooks list")}`,
      `  ${formatCliCommand("simpleclaw hooks enable <name>")}`,
      `  ${formatCliCommand("simpleclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
