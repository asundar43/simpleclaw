...
export function applyOpencodeZenProviderConfig(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyOpencodeZenConfig(cfg: SimpleClawConfig): SimpleClawConfig {
