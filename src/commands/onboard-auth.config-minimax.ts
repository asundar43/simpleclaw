...
export function applyMinimaxProviderConfig(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyMinimaxConfig(cfg: SimpleClawConfig): SimpleClawConfig {
