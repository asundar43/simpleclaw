...
export function applyOpenAIProviderConfig(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyOpenAIConfig(cfg: SimpleClawConfig): SimpleClawConfig {
