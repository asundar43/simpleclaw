...
function resolveDefaultAccountId(cfg: SimpleClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SimpleClawConfig): boolean {
...
export function summarizeBindings(cfg: SimpleClawConfig, bindings: AgentBinding[]): string[] {
