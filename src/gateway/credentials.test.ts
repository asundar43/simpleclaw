...
function cfg(input: Partial<SimpleClawConfig>): SimpleClawConfig {
  return input as SimpleClawConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<SimpleClawConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  SIMPLECLAW_GATEWAY_TOKEN: "env-token",
  SIMPLECLAW_GATEWAY_PASSWORD: "env-password",
