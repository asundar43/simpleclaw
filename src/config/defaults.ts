...
function resolveAnthropicDefaultAuthMode(cfg: SimpleClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyTalkApiKey(config: SimpleClawConfig): SimpleClawConfig {
...
export function applyTalkConfigNormalization(config: SimpleClawConfig): SimpleClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyLoggingDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyContextPruningDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
...
export function applyCompactionDefaults(cfg: SimpleClawConfig): SimpleClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
