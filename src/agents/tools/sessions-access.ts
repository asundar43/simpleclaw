...
export function resolveSessionToolsVisibility(cfg: SimpleClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: SimpleClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: SimpleClawConfig): AgentToAgentPolicy {
