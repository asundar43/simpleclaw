...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): SimpleClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: SimpleClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: SimpleClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
