...
function asSimpleClawConfig(config: Partial<SimpleClawConfig>): SimpleClawConfig {
  return config as SimpleClawConfig;
}

function createToolConfig() {
  return asSimpleClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: SimpleClawConfig = createToolConfig()) {
