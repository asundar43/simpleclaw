...
type SimpleClawReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: SimpleClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSimpleClawReadTool(base, {
...
export function createSimpleClawReadTool(
  base: AnyAgentTool,
  options?: SimpleClawReadToolOptions,
): AnyAgentTool {
