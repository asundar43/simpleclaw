...
function resolveAvatarSource(cfg: SimpleClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SimpleClawConfig, agentId: string): AgentAvatarResolution {
