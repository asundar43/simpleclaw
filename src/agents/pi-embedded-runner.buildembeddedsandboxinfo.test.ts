...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/simpleclaw-sandbox",
    agentWorkspaceDir: "/tmp/simpleclaw-workspace",
    workspaceAccess: "none",
    containerName: "simpleclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "simpleclaw-sbx-browser-test",
    },
