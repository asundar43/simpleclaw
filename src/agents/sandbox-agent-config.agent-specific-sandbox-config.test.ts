...
async function resolveContext(config: SimpleClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): SimpleClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
