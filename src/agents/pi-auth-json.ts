...
/**
 * Convert an SimpleClaw auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * SimpleClaw stores credentials in auth-profiles.json instead. This helper
