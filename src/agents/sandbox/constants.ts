...
export const DEFAULT_SANDBOX_IMAGE = "simpleclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "simpleclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "simpleclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "simpleclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "simpleclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "simpleclaw-sandbox-browser";
