...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSimpleClawAgentDir() returns mainAgentDir
    process.env.SIMPLECLAW_STATE_DIR = tmpDir;
    process.env.SIMPLECLAW_AGENT_DIR = mainAgentDir;
