...
type AgentEntry = NonNullable<NonNullable<SimpleClawConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: SimpleClawConfig): AgentEntry[] {
...
export function listAgentIds(cfg: SimpleClawConfig): string[] {
...
function resolveAgentEntry(cfg: SimpleClawConfig, agentId: string): AgentEntry | undefined {
...
export function resolveRunModelFallbacksOverride(params: {
  cfg: SimpleClawConfig | undefined;
  agentId?: string | null;
  sessionKey?: string | null;
}): string[] | undefined {
  if (!params.cfg) {
...
export function resolveAgentWorkspaceDir(cfg: SimpleClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: SimpleClawConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
