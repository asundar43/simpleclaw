...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("simpleclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("simpleclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("simpleclaw-cache-test2-");
