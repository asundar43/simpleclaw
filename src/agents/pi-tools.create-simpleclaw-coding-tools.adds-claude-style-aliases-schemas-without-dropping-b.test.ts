...
const defaultTools = createSimpleClawCodingTools({ senderIsOwner: true });
...
describe("createSimpleClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: SimpleClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createSimpleClawCodingTools({
    ...
    const anthropicTools = createSimpleClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: SimpleClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createSimpleClawCodingTools({
    ...
    const denied = createSimpleClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createSimpleClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
