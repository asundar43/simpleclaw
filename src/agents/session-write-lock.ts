...
const CLEANUP_STATE_KEY = Symbol.for("simpleclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("simpleclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("simpleclaw.sessionWriteLockWatchdogState");
