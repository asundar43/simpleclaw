...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: SimpleClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: SimpleClawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__simpleclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__simpleclawMcporterColdStartWarned;
  });
