...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SIMPLECLAW_TTS_PREFS;
      process.env.SIMPLECLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SIMPLECLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: SimpleClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
