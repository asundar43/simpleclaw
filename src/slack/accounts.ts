...
function mergeSlackAccountConfig(cfg: SimpleClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SimpleClawConfig): ResolvedSlackAccount[] {
