...
// Prefix for SimpleClaw-generated action IDs to scope our handler
const SIMPLECLAW_ACTION_PREFIX = "simpleclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${SIMPLECLAW_ACTION_PREFIX}`);

  // Handle SimpleClaw modal submissions with callback_ids scoped by our prefix.
