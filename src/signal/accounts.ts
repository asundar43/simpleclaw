...
function mergeSignalAccountConfig(cfg: SimpleClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SimpleClawConfig): ResolvedSignalAccount[] {
