...
function mergeDiscordAccountConfig(cfg: SimpleClawConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: SimpleClawConfig): ResolvedDiscordAccount[] {
