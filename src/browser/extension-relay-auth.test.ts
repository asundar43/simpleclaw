...
import {
  probeAuthenticatedSimpleClawRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated simpleclaw relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedSimpleClawRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-simpleclaw-relay-token",
