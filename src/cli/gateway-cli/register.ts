      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["simpleclaw gateway run", "Run the gateway in the foreground."],
            ["simpleclaw gateway status", "Show service status and probe reachability."],
            ["simpleclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["simpleclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.simpleclaw.ai/cli/gateway")}\n`,
      ),
  );
