...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.SIMPLECLAW_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.SIMPLECLAW_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<SimpleClawConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live SimpleClaw docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage SimpleClaw plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
