    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["simpleclaw channels list", "List configured channels and auth profiles."],
          ["simpleclaw channels status --probe", "Run channel status checks and probes."],
          [
            "simpleclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["simpleclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.simpleclaw.ai/cli/channels",
        )}\n`,
    );
