...
const SANDBOX_EXAMPLES = {
  main: [
    ["simpleclaw sandbox list", "List all sandbox containers."],
    ["simpleclaw sandbox list --browser", "List only browser containers."],
    ["simpleclaw sandbox recreate --all", "Recreate all containers."],
    ["simpleclaw sandbox recreate --session main", "Recreate a specific session."],
    ["simpleclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["simpleclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["simpleclaw sandbox list", "List all sandbox containers."],
    ["simpleclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["simpleclaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "simpleclaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["simpleclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["simpleclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["simpleclaw sandbox explain", "Show effective sandbox config."],
    ["simpleclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["simpleclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["simpleclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.simpleclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
