    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["simpleclaw directory self --channel slack", "Show the connected account identity."],
          [
            'simpleclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["simpleclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "simpleclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.simpleclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
