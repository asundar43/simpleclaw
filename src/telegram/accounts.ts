...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SIMPLECLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SimpleClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SimpleClawConfig): string {
...
export function listEnabledTelegramAccounts(cfg: SimpleClawConfig): ResolvedTelegramAccount[] {
