...
export type ChannelAgentToolFactory = (params: { cfg?: SimpleClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SimpleClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SimpleClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SimpleClawConfig }) => boolean;
  supportsCards?: (params: { cfg: SimpleClawConfig }) => boolean;
