...
export function listChannelMessageActions(cfg: SimpleClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: SimpleClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: SimpleClawConfig): boolean {
