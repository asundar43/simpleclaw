...
import { discoverSimpleClawPlugins } from "../../plugins/discovery.js";
import type { SimpleClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SimpleClawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SIMPLECLAW_PLUGIN_CATALOG_PATHS", "SIMPLECLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SimpleClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SimpleClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SimpleClawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSimpleClawPlugins({ workspaceDir: options.workspaceDir });
