...
export type SimpleClawPluginConfigSchema = {
...
export type SimpleClawPluginToolContext = {
...
export type SimpleClawPluginToolFactory = (
  ctx: SimpleClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SimpleClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SimpleClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<SimpleClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type SimpleClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current SimpleClaw configuration */
  config: SimpleClawConfig;
 ...
 */
export type SimpleClawPluginCommandDefinition = {
...
export type SimpleClawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type SimpleClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type SimpleClawPluginCliContext = {
  program: Command;
  config: SimpleClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type SimpleClawPluginCliRegistrar = (
  ctx: SimpleClawPluginCliContext,
) => void | Promise<void>;

export type SimpleClawPluginServiceContext = {
  config: SimpleClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type SimpleClawPluginService = {
  id: string;
  start: (ctx: SimpleClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: SimpleClawPluginServiceContext) => void | Promise<void>;
};

export type SimpleClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type SimpleClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: SimpleClawPluginConfigSchema;
  register?: (api: SimpleClawPluginApi) => void | Promise<void>;
  activate?: (api: SimpleClawPluginApi) => void | Promise<void>;
};

export type SimpleClawPluginModule =
  | SimpleClawPluginDefinition
  | ((api: SimpleClawPluginApi) => void | Promise<void>);

export type SimpleClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | SimpleClawPluginToolFactory,
    opts?: SimpleClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: SimpleClawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: SimpleClawPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: SimpleClawPluginHttpRouteHandler }) => void;
  registerChannel: (registration: SimpleClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: SimpleClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: SimpleClawPluginService) => void;
   ...
   */
  registerCommand: (command: SimpleClawPluginCommandDefinition) => void;
