...
import {
  ...
  type SimpleClawPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @simpleclaw/voice-call -> voice-call).
...
export function discoverSimpleClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".simpleclaw", "extensions")];
