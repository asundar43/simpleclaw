...
const CORE_PACKAGE_NAMES = new Set(["simpleclaw"]);
...
export async function resolveSimpleClawPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSimpleClawPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
