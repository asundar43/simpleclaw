...
从 `CHANGELOG.md`（通过 [`scripts/changelog-to-html.sh`](https://github.com/simpleclaw/simpleclaw/blob/main/scripts/changelog-to-html.sh)）生成 HTML 发布说明，并将其嵌入 appcast 条目。
