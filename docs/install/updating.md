...
- `pnpm build` matters when you run the packaged `openclaw` binary ([`openclaw.mjs`](https://github.com/simpleclaw/simpleclaw/blob/main/openclaw.mjs)) or use Node to run `dist/`.
