...
if [[ -z "$version_content" ]]; then
  echo "<h2>SimpleClaw $VERSION</h2>"
  echo "<p>Latest SimpleClaw update.</p>"
  echo "<p><a href=\"https://github.com/simpleclaw/simpleclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
