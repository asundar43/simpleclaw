...
# Output:
# - dist/SimpleClaw.app
# - dist/SimpleClaw-<version>.zip
# - dist/SimpleClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.simpleclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/SimpleClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/SimpleClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/SimpleClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SimpleClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SimpleClaw-$VERSION.dSYM.zip"
